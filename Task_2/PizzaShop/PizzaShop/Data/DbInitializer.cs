...
namespace PizzaShop.Data
{
    public class DbInitializer
    {
        public static void Initialize(AppDbContext context, IServiceProvider service)
        {
            ...
            CreateAdminRole(roleManager, userManager);
            SeedDatabase(context, roleManager, userManager);
        }

        private static void CreateAdminRole(RoleManager<IdentityRole> _roleManager, UserManager<IdentityUser> _userManager)
        {
