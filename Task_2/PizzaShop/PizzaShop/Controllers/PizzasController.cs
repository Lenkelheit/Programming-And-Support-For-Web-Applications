...
namespace PizzaShop.Controllers
{
    ...
    public class PizzasController : Controller
    {
        ...
        public PizzasController(AppDbContext context, IPizzaRepository pizzaRepo, IEntityRepository<Category> categoryRepo)
        {
            _context = context;
        ...
        private async Task<List<Pizza>> GetPizzaSearchList(string userInput)
        {
        ...
        {
            IEnumerable<Pizza> pizzaList = null;
            ...
            {
                pizzaList = await GetPizzaSearchList(searchString);
            }
        ...
        public async Task<IActionResult> ListAll([Bind("SearchText")] SearchPizzasViewModel model)
        {
            ...
            else
            {
                ...
                {
                    model.PizzaList = new List<Pizza>();
                }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("Id,Name,Price,Description,ImageUrl,IsPizzaOfTheWeek,CategoryId")] Pizza pizzas)
        {
            ...
            ViewData["CategoryId"] = new SelectList(_categoryRepo.GetAll(), "Id", "Name", pizzas.CategoryId);
            return View(pizzas);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price,Description,ImageUrl,IsPizzaOfTheWeek,CategoryId")] Pizza pizzas)
        {
            if (id != pizzas.Id)
            {
                return NotFound();
