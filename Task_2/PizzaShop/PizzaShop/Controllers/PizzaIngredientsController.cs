...
namespace PizzaShop.Controllers
{
    ...
    public class PizzaIngredientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,PizzaId,IngredientId")] PizzaIngredient pizzaIngredients)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PizzaId,IngredientId")] PizzaIngredient pizzaIngredients)
        {
